...
const Soundbox = () => {
  return (
    <div className="w-1/2 flex flex-col justify-center items-center">
      <h1 className="text-8xl text-transparent font-lexend font-extrabold bg-[linear-gradient(to_right,_#FF0000,_#B00000,_#1DB954,_#FF5500)]  
        bg-[length:200%_200%] bg-clip-text animate-gradient">SoundBox</h1>
